...
//       {!object?.recipe && (
//         <h1 className="text-center text-4xl font-bold">הצ'אטבוט של מודלה!</h1>
//       )}
...
//             <div>
//               <h3 className="text-xl font-semibold mb-4">מרכיבים:</h3>
...
//           {object?.recipe?.steps && (
//             <div>
//               <h3 className="text-xl font-semibold mb-4">שלבי ההכנה:</h3>
...
//             >
//               {isLoading ? 'יוצר מתכון...' : 'צור מתכון'}
//             </button>
//           )}
//           {/* Conditional button:
...
//             placeholder="מה מכינים היום, מודלה?"
